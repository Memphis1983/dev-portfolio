...
}( this, window, document, function ( e, t )
{
  ...
  function Le( n, o, i )
  {
    var r;
    i = void 0 === i ?
    {} : i, "function" == typeof e.CustomEvent ? r = new CustomEvent( o,
    {
      detail: i
  ...
  return e.NodeList && !NodeList.prototype.forEach && ( NodeList.prototype.forEach = function ( t, n )
    ...
    function ( P, F )
    {
      ...
      if ( !Q( K( "html" ), a ) )
      {
        ...
        Ue.k = q(
        {}, Ue.m );
        var Fe, We, Xe, _e, Ke, qe, Qe, Ge, $e = e.PointerEvent ?
          {
            down: "pointerdown",
            move: "pointermove"
          } :
      ...
      function Ct( e, n, o )
      {
        ...
        } ) ), F.loopHorizontal || le( K( U, a ) ) ), F.slidesNavigation && function ( e, t )
        {
          ...
          for ( var o = 0; o < t; o++ ) fe( Ae( '<li><a href="#"><span class="fp-sr-only">' + Ht( o, "Slide" ) + "</span><span></span></a></li>" ), K( "ul", n )[ 0 ] );
          $( n,
          {
      ...
      function ln( e )
      {
        ...
        9 === o ? function ( e )
        {
          var n, o, i, r, l, a, s, c = e.shiftKey,
            u = t.activeElement,
            f = un( tn( K( g )[ 0 ] ) );
      ...
      function Tn( e, t )
      {
        ...
        if ( null != n )
        {
          var o, i, r, l = ( null == ( r = K( M + '[data-anchor="' + ( o = t ) + '"]', i = n )[ 0 ] ) && ( o = void 0 !== o ? o : 0, r = K( M, i )[ o ] ), r );
      ...
      function Mn( t )
      {
        if ( F.recordHistory ) location.hash = t;
      ...
      {
        var t = Math.round( e );
        if ( F.css3 && F.autoScrolling && !F.scrollBar ) Ln( "translate3d(0px, -" + t + "px, 0px)", !1 );
        else if ( F.autoScrolling && !F.scrollBar ) $( Ne,
        {
          top: -t + "px"
        } ), de.test.top = -t + "px";
        else
      ...
      function Pn( t, n, o, i )
      {
        var r, l = ( r = t ).self != e && Q( r, C ) ? r.scrollLeft : !F.autoScrolling || F.scrollBar ? be() : r.offsetTop,
          a = n - l,
          s = 0;
        Ge = !0;
        var c = function ()
